...
export const calculateOtherPrices = async (payload?: any) => {
    ...
    const  interiorDesign =  payload.service.interiorDesign * extendRefurbishArea ;
    const  architectural =  payload.service.architectural * extendRefurbishArea;
    const  structuralEngineering =  payload.service.structuralEngineering * extendRefurbishArea;
    const  planning =  payload.service.planning * extendRefurbishArea;
