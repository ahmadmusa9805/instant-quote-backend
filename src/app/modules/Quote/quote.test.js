...
// console.log(result, "result");
///////
function convertKeysToCamelCase(serviceObject) {
    return Object.keys(serviceObject).reduce((result, key) => {
...
const service = {
    'Interior Design': 30,
    'Architectural Desing': 25,
    'Structural Engineering': 50,
    planning: 40,
    'Project Management': 35,
};

const camelCaseService = convertKeysToCamelCase(service);
console.log(camelCaseService, "camelCaseService");